...
import LMU_Logo from '../images/LMU_Logo.jpeg';
...
import TU_Logo from '../images/TU-Ilmenau-Logo-quadratisch.png';
    ...
    <section id="hintergrund">
        <div class="textbereich">
            ...
            Diese Plattform wird von Mitgliedern des Lehrstuhls für Ökonometrie und Statistik am Karlsruher Institut für Technologie sowie der Computational Statistics Gruppe am Heidelberger Institut für Theoretische Studien betrieben. Mehrere unabhängige weitere Gruppen aus Wissenschaft und Medien tragen Nowcasts bei (siehe auch Metadata-Files in unserem GitHub Repository):
                ...
                <br />
            <ul> 
                <li class="Gruppen"> <img class="logo"  src={TU_Logo} alt="TU Ilmenau Logo"></img> <a href="https://www.tu-ilmenau.de/stochastik/"> Institut für Mathematik, TU Ilmenau</a></li>
                <li class="Gruppen"> <img class="logo"  src={LMU_Logo} alt="LMU_Logo"></img> <a href="https://corona.stat.uni-muenchen.de/"> Statistisches Beratungslabor, LMU München </a> </li>
                <li class="Gruppen"> <img class="logo"  src={RIVM_Logo} alt="RIVM_Logo"></img> <a href="https://www.rivm.nl/en">RIVM (Rijksinstituut voor Volksgezondheid en Milieu), Bilthoven, Niederlande </a></li>
                <li class="Gruppen"> <img class="logo"  src={Stockholm_Logo} alt="Uni_stockholm"></img> <a href="https://www.su.se/english/profiles/fegu7762-1.554768"> Department Mathematik, Universität Stockholm </a></li>
                <li class="Gruppen"> <img class="logo"  src={SZ_Logo} alt="SZ_Logo"></img> <a href="https://www.sueddeutsche.de/thema/Coronavirus"> Süddeutsche Zeitung </a></li>
                <li class="Gruppen"> <img class="logo"  src={london_logo} alt="london-School-Hygiene-Tropical"></img> <a href="https://epiforecasts.io/"> London School of Hygiene and Tropical Medicine / epiforecasts </a></li>
            </ul>
                <br />
